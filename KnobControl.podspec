...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "DevelopBot" => "no-reply@coway.com" }
  # Or just: spec.author    = "DevelopBot"
  # spec.authors            = { "DevelopBot" => "no-reply@coway.com" }
  # spec.social_media_url   = "https://twitter.com/DevelopBot"
  ...
  spec.source_files  = "KnobControl", "KnobControl/**/*.{h,m}"
  spec.exclude_files = "KnobControl/Exclude"
